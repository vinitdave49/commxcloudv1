...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'commcloud_twilio_wrapper.twilio_api' => 'getCommcloudTwilioWrapper_TwilioApiService',
            'commcloud_twilio_wrapper.twilio_capability' => 'getCommcloudTwilioWrapper_TwilioCapabilityService',
            'commcloud_twilio_wrapper.twilio_taskrouter' => 'getCommcloudTwilioWrapper_TwilioTaskrouterService',
            'commcloud_twilio_wrapper.twilio_taskrouter_worker_capability' => 'getCommcloudTwilioWrapper_TwilioTaskrouterWorkerCapabilityService',
            ...
            'security.user.provider.concrete.mysql' => 'getSecurity_User_Provider_Concrete_MysqlService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CommcloudVoiceBundle', ($this->targetDirs[3].'/app/Resources/CommcloudVoiceBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'CommcloudVoiceBundle', ($this->targetDirs[3].'/src/Commcloud/VoiceBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'commcloud_twilio_wrapper.twilio_api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Commcloud\VoiceBundle\Service\TwilioWrapper A Commcloud\VoiceBundle\Service\TwilioWrapper instance.
     */
    protected function getCommcloudTwilioWrapper_TwilioApiService()
    {
        return $this->services['commcloud_twilio_wrapper.twilio_api'] = new \Commcloud\VoiceBundle\Service\TwilioWrapper('AC0f18494502dee91457252ff7b2bada6a', '2f430f7691acb543889ef3a721c1c096', 5, '2010-04-01');
    }

    /**
     * Gets the 'commcloud_twilio_wrapper.twilio_capability' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Commcloud\VoiceBundle\Service\TwilioCapabilityWrapper A Commcloud\VoiceBundle\Service\TwilioCapabilityWrapper instance.
     */
    protected function getCommcloudTwilioWrapper_TwilioCapabilityService()
    {
        return $this->services['commcloud_twilio_wrapper.twilio_capability'] = new \Commcloud\VoiceBundle\Service\TwilioCapabilityWrapper('AC0f18494502dee91457252ff7b2bada6a', '2f430f7691acb543889ef3a721c1c096');
    }

    /**
     * Gets the 'commcloud_twilio_wrapper.twilio_taskrouter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Commcloud\VoiceBundle\Service\TwilioTaskRouterWrapper A Commcloud\VoiceBundle\Service\TwilioTaskRouterWrapper instance.
     */
    protected function getCommcloudTwilioWrapper_TwilioTaskrouterService()
    {
        return $this->services['commcloud_twilio_wrapper.twilio_taskrouter'] = new \Commcloud\VoiceBundle\Service\TwilioTaskRouterWrapper('AC0f18494502dee91457252ff7b2bada6a', '2f430f7691acb543889ef3a721c1c096', 'WSce7860a1dd3d977493b7e15bead4e320', 5);
    }

    /**
     * Gets the 'commcloud_twilio_wrapper.twilio_taskrouter_worker_capability' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Commcloud\VoiceBundle\Service\TwilioTaskRouterWorkerCapabilityWrapper A Commcloud\VoiceBundle\Service\TwilioTaskRouterWorkerCapabilityWrapper instance.
     */
    protected function getCommcloudTwilioWrapper_TwilioTaskrouterWorkerCapabilityService()
    {
        return $this->services['commcloud_twilio_wrapper.twilio_taskrouter_worker_capability'] = new \Commcloud\VoiceBundle\Service\TwilioTaskRouterWorkerCapabilityWrapper('AC0f18494502dee91457252ff7b2bada6a', '2f430f7691acb543889ef3a721c1c096', 'WSce7860a1dd3d977493b7e15bead4e320', 'WK2d358d220ef9e662b9f3dd7c8cf85d7c');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'db_twilio', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Commcloud/VoiceBundle/Resources/config/doctrine') => 'Commcloud\\VoiceBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Commcloud\\VoiceBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CommcloudVoiceBundle' => 'Commcloud\\VoiceBundle\\Entity'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Commcloud\\VoiceBundle\\Entity\\WorkerInfo' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/app');
        ...
        $m->setOptions(array('login_path' => '/login', 'default_target_path' => '/app/content', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $j, 1 => $this->get('security.user.provider.concrete.mysql')), 'main', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'main', $m, $n, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '575ed363e40f49.19684275', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'CommcloudVoiceBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Commcloud/VoiceBundle/Resources/views'), 'CommcloudVoice');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e7655878c273ac35baf2d2ad83975632c78e0ceb');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.mysql'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575ed363e40f49.19684275')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SUPERVISOR'), 'ROLE_SUPERVISOR' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH', 3 => 'ROLE_SUPERVISOR')));
    }

    /**
     * Gets the 'security.user.provider.concrete.mysql' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_MysqlService()
    {
        return $this->services['security.user.provider.concrete.mysql'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Commcloud\\VoiceBundle\\Entity\\WorkerInfo', 'wemail', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CommcloudVoiceBundle' => 'Commcloud\\VoiceBundle\\CommcloudVoiceBundle',
            ...
            'locale' => 'en',
            'secret' => 'e7655878c273ac35baf2d2ad83975632c78e0ceb',
            'debug_toolbar' => true,
            ...
            'version' => '2010-04-01',
            'retryattempts' => 5,
            'workersid' => 'WK2d358d220ef9e662b9f3dd7c8cf85d7c',
            'workflowsid' => 'WW542a85c0b81a847430d95d3dbc75f8a5',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e7655878c273ac35baf2d2ad83975632c78e0ceb',
            ...
            'assetic.node.bin' => ($this->targetDirs[4].'/.nvm/versions/node/v4.1.1/bin/node'),
